...
DEFAULT_HEURISTIC = Heuristics.SCORE | Heuristics.ALL_CORNERS
DEFAULT_ORDERING = ChildrenOrdering.HEURISTIC
...
class BlokusCompetitionAgent (GameAgent):
    ...
    def __init__(self, depth=2, heuristicType=DEFAULT_HEURISTIC, \
            timeManagement=0, \
            selectiveDeepening=0,\
            childrenOrdering=DEFAULT_ORDERING):
